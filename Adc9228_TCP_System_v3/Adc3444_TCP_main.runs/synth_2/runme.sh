...
HD_PWD='E:/ZynqProject_v17/Adc9228_TCP_System_v3/Adc3444_TCP_main.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log Adc3444_TCP_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adc3444_TCP_wrapper.tcl
