...
HD_PWD='E:/ZynqProject_v17/Adc9228_TCP_System_v3/Adc3444_TCP_main.runs/Adc3444_TCP_TriggerCh_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adc3444_TCP_TriggerCh_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adc3444_TCP_TriggerCh_2_0.tcl
